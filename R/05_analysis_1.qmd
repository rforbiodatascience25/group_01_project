...
```{r distribution_gene_expression_inflamed_uninflamed, fig-format="png"}
finaldata |> 
...
```{r gene_expression_by_anatomic_location_and_inflammation, fig-format="png"}
...
```{r mean_gene_expression_per_patient_inflamed_uninflamed, fig-format="png"}
...
```{r volcano_plot_colonic_gene_expression, fig-format="png"}
...
```{r top40_differential_genes_across_samples, fig-format="png"}
