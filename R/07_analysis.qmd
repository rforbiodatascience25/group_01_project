...
```{r time_to_diagnosis_vs_smoking_status, fig-format="png"}
finaldata |>  
...
```{r time_to_diagnosis_vs_age, fig-format="png"}
finaldata |>  
...
```{r gc_content_comparison_healthy_vs_diseased, fig-format="png"}
...
```{r at_content_comparison_healthy_vs_diseased, fig-format="png"}
...
```{r significant_gene_counts_by_anatomic_location, fig-format="png"}
de_by_loc <- finaldata |>
